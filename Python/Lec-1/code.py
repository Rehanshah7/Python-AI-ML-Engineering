...
print("Enter your name and age and print them")
...
print("Enter two numbers and print their sum, difference, product, and quotient")
...
print("Enter two integers and one float to calculate their average")
...
print("Enter a string containing a number to convert it to integer, float and string")
...
print("Evaluate and print the result of the expression: x = 10 + 3 * 2 ** 2")
x_f = 10 + 3 * 2 ** 2
print(x_f, "\n")
...
print("Enter temperature in Celsius to convert it to Fahrenheit")
celsius = input("Enter temperature in Celsius: ")
fahrenheit = (float(celsius) * 9/5) + 32
print("Temperature in Fahrenheit:", fahrenheit, "\n")

# 8. Take the radius (r) as user input and print the area of a circle
print("Enter the radius to calculate the area of a circle")
r = int(input("Enter radius: "))
area = 3.14 * r * r
print("Area of circle:", area, "\n")

# 9. Ask the user for: Principal (P), Rate (R), Time (T). Convert all to and compute simple interest
print("Enter Principal, Rate and Time to calculate Simple Interest")
...
print("Enter two numbers to swap without using a temporary variable")
...
print("Enter a decimal number to separate its integer and fractional parts")
